            ...
            <div className="inner-area">
                <div className="flexbox effect-fade">
                    ...
                    <div className="text effect-fade">
                        <dl>
                            <dt>HTML/CSS</dt>
                            <dd>使用歴4年。W3Cに準拠し、SEOにも対応した適切なマークアップを心がけています。また、CSSに関しては「修正しやすく、分かりやすい」書き方を常に意思したCSS設計を心がけています。</dd>

                            <dt>JavaScript</dt>
                            <dd>使用歴4年。バニラJSでの1からのプログラミングが可能。動くサイトの制作やフォームのバリデーションの実装を行います。</dd>
                            
                            <dt>React.js/Next.js</dt>
                            <dd>使用歴2年。</dd>

                            <dt>PHP</dt>
                            <dd>使用歴4年。お問い合わせフォームやログイン機能、パッチ処理などの実装が可能です。</dd>

                            <dt>WordPress</dt>
                            <dd>使用歴4年。HTMLやPHPファイルからオリジナルのテーマの作成が可能です。</dd>

                            <dt>Photoshop/Illustrator</dt>
                            <dd>使用歴4年。バナーやアイコンの作成、写真の加工が可能です。写真のレタッチ・リサイズや画像の切り抜きなどの対応も可能です。Photoshopで作成されたデザインカンプからのコーディングにも対応しております。</dd>
                        </dl>
                    </div>
                </div>
            </div>
