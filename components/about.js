                    ...
                    <div className="profile">
                        <dl>
                            ...
                            <dt>
                                ...
                                制作会社にてプロジェクトのディレクション～制作を一貫して行っています。 これまでコーポレイトサイト、サービスサイト、ランディングページ、ECサイトなど多数のサイト、プロジェクトに携わらせていただき、 サイトやアプリケーションを作成させて頂いております。<br />
                                接客・営業職も行っていた経験から、クライアント様にとってスムーズで気持ちの良いディレクション、コミュニケーションを常日頃から心がけております。<br />
